...
import dummydata.R;
import dummydata.databinding.ActivityWebViewBinding;
...
//    private AdManagerAdView admobBanner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView storyWebView = (WebView) findViewById(R.id.webview_story);
        storyWebView.loadUrl(url);

        storyWebView.setWebViewClient(new WebViewClient() {
            @Override
            public void onPageFinished(WebView storyWebView, String url) {
                super.onPageFinished(storyWebView, url);
...
/**** Unity Ads ****/
        ...
        binding.webViewAdContainer.addView(unityBanner);
        unityBanner.load();
    }

    public void loadAdmobBanner() {
        admobBanner = new AdView(this);
        binding.webViewAdContainer.addView(admobBanner);
    ...
    private void loadTapdaqBanner() {
        ...
        binding.webViewAdContainer.addView(tapdaqBanner);
    ...
    private void loadApplovinBanner() {
        ...
        int heightDp = MaxAdFormat.BANNER.getAdaptiveSize(WebViewActivity.this).getHeight();
        int heightPx = AppLovinSdkUtils.dpToPx(WebViewActivity.this, heightDp);

        applovinBanner1 = new MaxAdView(getString(R.string.appl_banner_default), WebViewActivity.this);
        ...
        binding.webViewAdContainer.addView(applovinBanner1);
...
//        IronSource.init(this, getString(R.string.ironSource_app_id), IronSource.AD_UNIT.BANNER);
        ...
        binding.webViewAdContainer.addView(ironSourceBanner);

        binding.webViewAdContainer.setVisibility(View.VISIBLE);
...
//        AlertDialog.Builder progressDialog = new AlertDialog.Builder(StoryActivity.this);
        progressDialog = new AlertDialog.Builder(WebViewActivity.this);
        View rootView1 = LayoutInflater.from(WebViewActivity.this).inflate(R.layout.layout_dialog_progress,
